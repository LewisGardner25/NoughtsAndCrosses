...
//            expect('noughtsAndCrossesApp.service(gameApi,function ($http,$q,gameApiConstants)')
//    });
//
...
//            expect(gameApi.makeMove.playerNumber = 'playerNumber',gameApi.makeMove.squareNumber = 'squareNumber');
//    });
//
//    it('newGame function contains constants', function(){
//        expect(noughtsAndCrossesApp.gameApi.newGame)
//            expect(gameApi.newGame.player1 = 'player1Type',gameApi.newGame.player2 = 'player2Type');
//    });
//
//    it('gameApi service contains promise', function(){
//        expect(noughtsAndCrossesApp.gameApi)
//            expect(gameApi.to.have.property('serverCall'));
//    });
//
//});
